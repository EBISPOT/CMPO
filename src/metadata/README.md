 ...
 * [cmpo.yml](cmpo.yml)
     * Determines how your purl.obolibrary.org/obo/cmpo/ redirects will be handled
     ...
     * Paste in the contents of [cmpo.yml](cmpo.yml)
 ...
 * [cmpo.md](cmpo.md)
     ...
     * Paste in the contents of [cmpo.md](cmpo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
